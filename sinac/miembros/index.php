			...
			<div class="row">
				<div class="col-md-5 wrap-contact3">
					<form method="post" class="frmsinac contact3-form validate-form" id="frmMiembro" autocomplete="on">
						...
						<button type="submit" class="btn btn-primary" id="submit" name="submitAdd" value="Submit" onclick="submitButtonAdd('miembro');">Registrar</button>
						<button type="submit" class="btn btn-primary modificar" id="submit" name="submitAdd" value="Submit" onclick="onUpdateMiembros()">Modificar</button>
