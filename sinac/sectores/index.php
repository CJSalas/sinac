			...
			<div class="row">
				<div class="col-md-5 wrap-contact3">
					<form method="post" class="frmsinac contact3-form" id="frmSectores" autocomplete="on">
						...
						<button type="submit" class="btn btn-primary modificar" id="submit" name="submitAdd" value="Submit" onclick="onUpdateSectors(document.getElementById('txtNombreSector').name, document.getElementById('txtNombreSector').value)">Modificar</button>
