			...
			<div class="row">
				<div class="col-md-5 wrap-contact3">
					<form method="post" class="frmsinac contact3-form" id="frmCOLAC" autocomplete="on">
						...
						<button type="submit" class="btn btn-primary" id="submitR" name="submitAdd" value="Submit" onclick="submitButtonAdd('colac');">Registrar</button>
						<button type="submit" class="btn btn-primary modificar" id="submitE" name="submitAdd" value="Submit" onclick="onUpdateColacs(document.getElementById('txtNombreColac').name, document.getElementById('txtNombreColac').value, $('#select_coracs').val(), $('#select_conacs').val())">Modificar</button>
